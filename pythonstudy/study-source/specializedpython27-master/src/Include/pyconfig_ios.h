...
/* Define if you want to use the more memory-efficient
   implementation of dict objects. */
#define Py_COMPACT_DICT

/* Define if the C compiler supports computed gotos
   and you want to use it for faster opcode dispatch. */
...
/* Define if you want to use code cache
   to save memory from not frequently used code. */
/* #undef Py_CODE_CACHE */
