...
#define _Py_IS_TYPE(ob, type) ((ob)->ob_type == (type))
...
/* end Py3k buffer interface */
    ...
    typedef struct _typeobject {
        ...
        */
        adaptive_getattrofunc tp_adaptive_getattro;
        ...
        */
        adaptive_setattrofunc tp_adaptive_setattro;

        /*
        liuhan todo: finish later
        */
        adaptive_specializedictaccessfunc tp_adaptive_specializedictaccess;
...
#define PyType_CheckExact(op) (Py_TYPE(op) == &PyType_Type)
	...
	PyAPI_FUNC(PyObject*) _PyType_LookupDetail(PyTypeObject*, PyObject*, unsigned int* h, unsigned int* version);
	PyAPI_FUNC(PyObject*) _PyType_LookupCached(PyTypeObject*, PyObject*, const unsigned int h, const unsigned int version);
...
#define PyObject_Bytes PyObject_Str
	...
	PyAPI_FUNC(PyObject*) type_getattro(PyTypeObject*, PyObject*);
...
#define Py_TPFLAGS_ENABLE_ADAPTIVE_OPCODE (1L<<16)
