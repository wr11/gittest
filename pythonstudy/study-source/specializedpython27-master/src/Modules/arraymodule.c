...
//};
#define arraydescr PyArrayDescr
...
//} arrayobject;
#define arrayobject PyArrayObject

//static PyTypeObject PyArray_Type;
#define Arraytype PyArray_Type
...
struct arraydescr PyArrayDescriptors[] = {
...
#define descriptors PyArrayDescriptors
...
PyObject *
PyArray_New(Py_ssize_t size, struct PyArrayDescr *descr)
{
	return newarrayobject(&Arraytype, size,descr);
}
